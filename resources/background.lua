...
local boxes_settings = {
    -- Background
    {
        ...
        corners = {40, 40, 40 ,40},  -- TL, TR, BR, BL
    ...
    -- Second background layer with linear gradient
    {
        ...
        rotation = 0,  -- Toegevoegd voor rotatiemogelijkheid
        draw_me = true,
        linear_gradient = {260, 0, 260, 260},  -- Aangepast aan x en w
        colours = { {0, 0x0000ff, 0.5}, {0.6, 0x0000ff, 0.5}, {0.8, 0xff00ff, 0.5}, {1, 0xff00ff, 0.5} }
    },
    -- Border
    {
        type = "border",
